package com.example.smson.hello.parsing_xml;
...
import com.example.smson.hello.parsing_json.WebViewActivity;
...
public class XmlParsing extends ActionBarActivity implements AdapterView.OnItemClickListener{
    ...
    private void htmlParsing(String responseString) {
        ...
        // 3. 파싱한 데이터를 어댑터에 설정
        mAdapter = new AndroidPubAdapter(XmlParsing.this, mAndroidPubList);
