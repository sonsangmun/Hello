...
/**
 * Created by sangmun on 2015-04-17.
 */
public class ChatClient {
    private final static String SERVER_HOST = "192.168.0.62";
    private final static int SERVER_PORT = 65000;
    ...
    class ClientReceiver extends Thread {
        ...
        private final String TAG = ClientReceiver.class.getSimpleName();
